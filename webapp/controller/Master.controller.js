...
sap.ui.define([
		...
		"ibm/tlp/model/grouper",
		"ibm/tlp/model/GroupSortState"
		...
		return BaseController.extend("ibm.tlp.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("ibm.tlp.view.ViewSettingsDialog", this);
